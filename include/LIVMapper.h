...
{
public:
  LIVMapper(rclcpp::Node::SharedPtr &nh, std::string node_name);
  ~LIVMapper();

  void initializeSubscribersAndPublishers(rclcpp::Node::SharedPtr &nh, image_transport::ImageTransport &it);
  void initializeComponents(rclcpp::Node::SharedPtr &nh);
  void initializeFiles();
  void run(rclcpp::Node::SharedPtr &nh);
  ...
  void publish_odometry(const rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr &mavros_pose_publisherubOdomAftMapped);
...
builtin_interfaces::msg::Time get_ros_time(double time_double) {
...
double get_time_now(const builtin_interfaces::msg::Time &time_msg) {
